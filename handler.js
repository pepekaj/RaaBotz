...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.packname = '© wanzzBotz-MD'
        global.author = 'Made By kontol© 2022'
        global.packname2 = 'Made With'
        global.author2 = 'Raa Bot By wanzz © 2022'
        global.wm3 = '·͟͟͟͟͟͟͞͞͞͞͞͞Made By Cwanzz˚'
        global.wm2 = '©wanzz-𝘽𝙤𝙩𝙯-𝙈𝘿' + ' ' + 'By 𝐂𝐥𝐚𝐫𝐚𝐚'
        global.wm = '© wanzz-𝘽𝙤𝙩𝙯--𝙈𝘿'
        global.colong1 = 'Ciss 📸'
        global.colong2 = 'By Claraa'
        global.kontak2 = [
        ['6283181341902', 'Claraa', 'Creator Bot', 'Clarz939@support.com', true],
        ['628818172681', 'p Botz-MD', 'Bot WhatsApp', 'Just Bot', true]
        ]
